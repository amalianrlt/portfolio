        ...
        <Grid container>
          <Grid item lg={7}>
            <div className="connect" id="contact">
              ...
              <div className="icons">
              <a href="https://www.linkedin.com/in/amalia-nurlita-0b0a7a153/" rel="noopener noreferrer" target="_blank"><SvgIcon component={LinkedInIcon} style={{ fontSize: 50, }} clasName="linkedin"/></a>
          ...
          <div className="coding">
            <h3>Coding</h3>
              <div className="codingChild">
                <p><a href="" className="tagsButton">HTML/CSS</a></p>
                <p><a href="" className="tagsButton">JavaScript</a></p>
                <p><a href="" className="tagsButton">Git</a></p>
                <p><a href="" className="tagsButton">ReactJs</a></p>
                <p><a href="" className="tagsButton">CSS Libraries</a></p>
                <p><a href="" className="tagsButton">Responsive Web Design</a></p>
              </div>
          </div>
          <div className="coding">
            <h3>Design</h3>
            <div className="codingChild">
              <p><a href="" className="tagsButton">Figma</a></p>
              <p><a href="" className="tagsButton">Adobe XD</a></p>
              <p><a href="" className="tagsButton">Key Note</a></p>
            </div>
